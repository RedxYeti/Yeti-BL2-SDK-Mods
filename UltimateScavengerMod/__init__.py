...
def MissionWeapon(caller: UObject, function: UFunction, params: FStruct):
    Log(caller)
    return True
#mission reward functions
...
class UltimateScav(SDKMod):
    ...
    def Enable(self) -> None:
        ...
        RegisterHook("WillowGame.MissionTracker.GrantMissionWeaponsToClientPlayer", "MissionWeapon", MissionWeapon)
